...
const Profile = () => {
    ...
    const renderUserName = () => {
        switch(user.Type) {
            case 'student':
                return studentData?.student?.Fullname;
            case 'instructor':
                return instructorData?.instructor?.Instructorname;
            default:
                return 'Unknown';
        }
    };

    // Function to render email based on user type
    const renderUserEmail = () => {
        switch(user.Type) {
            case 'student':
                return studentData?.student?.Email;
            case 'instructor':
                return instructorData?.instructor?.Email;
            default:
                return 'Unknown';
        }
    };
    ...
    return (
        <div className="font-sans antialiased leading-normal tracking-wider text-gray-900">
            {/* Background Gradient */}
            <div className=" bg-gradient-to-tr from-orange-600 to-white">
                <div className="flex flex-wrap items-center h-auto max-w-4xl mx-auto my-32 lg:h-screen lg:my-0">
                    ...
                    <div id="profile" className="w-full mx-6 bg-white rounded-lg shadow-2xl opacity-75 lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none lg:mx-0">
                        <div className="p-4 text-center md:p-12 lg:text-left">
                            ...
                            <div className="w-4/5 pt-3 mx-auto border-b-2 border-orange-500 opacity-25 lg:mx-0"></div>
                            <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
                                <svg className="h-4 pr-4 text-orange-700 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            ...
                            <div className="pt-12 pb-8 space-x-6">
                                <button onClick={toggleEditing} className="px-4 py-2 font-bold text-white bg-orange-500 rounded-full hover:bg-orange-900">
                                    Edit Profile
                                </button>
                            ...
                            <div className="flex flex-wrap items-center justify-between w-4/5 pb-16 mx-auto mt-6 lg:pb-0 lg:w-full">
                                <a className="link" href="#" data-tippy-content="@facebook_handle">
                                    <svg className="h-6 text-gray-600 fill-current hover:text-orange-700" role="img" viewBox="0 0 24 24"
                                ...
                                <a className="link" href="#" data-tippy-content="@youtube_handle">
                                    <svg className="h-6 text-gray-600 fill-current hover:text-green-700" role="img"
                    ...
                    <div className="w-full lg:w-2/5">
                        <img src={userimg} className="hidden rounded-none shadow-2xl lg:rounded-lg lg:block" alt="Profile" />
                    </div>
                </div>
            </div>
        </div>
